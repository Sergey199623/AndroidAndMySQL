...
public class EditProductActivity extends Activity {
    ...
    private static final String url_product_detials = "http://адрес_сайта(сервера)/get_product_details.php";

    // url для обновления продукта
    private static final String url_update_product = "http://адрес_сайта(сервера)/update_product.php";

    // url для удаления продукта
    private static final String url_delete_product = "http://адрес_сайта(сервера)/delete_product.php";
